    ...
    <section>
        <div class="reg_img">
            ...
            <div class="box2">
                ...
                <h1 style="text-align: center; font-size: 27px; font-family: lucida console;">User Registration Form</h1> <br>
...
if(isset($_POST['submit']))
{
  ...
  if($count == 0)
  {
    $sql = "INSERT INTO user (first_name, last_name, username, password, address, email, contact) 
        VALUES ('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[address]', '$_POST[email]', '$_POST[contact]')";

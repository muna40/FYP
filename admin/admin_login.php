...
<body>
    ...
    <section>
        <div class="log_img">
            ...
            <div class="box1">
                ...
                if (isset($loginError)) {
                    echo "<div class='alert alert-danger' style='width: 600px; margin-left: 370px; background-color: #de1313; color: white'>";
    ...
    <?php
        if (isset($_POST['submit'])) 
        {
            ...
            {
                $loginError = "The username and password don't match.";
            } 
            else 
            {
